  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className={`flex items-center gap-2 px-3 py-2 rounded-xl transition-all duration-200 group ${isOpen ? "bg-gray-100 shadow-inner" : "hover:bg-gray-50"
          }`}
      >
        <Globe
          size={16}
          className={`transition-colors duration-200 ${isOpen ? "text-gray-900" : "text-gray-400 group-hover:text-gray-600"
            }`}
        />
        ...
        <ChevronDown
          size={14}
          className={`text-gray-400 transition-transform duration-300 ease-out ${isOpen ? "rotate-180 text-gray-900" : ""
            }`}
        />
      </button>
            ...
            {languages.map((lang) => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center justify-between px-4 py-2.5 text-sm transition-all ${isSelected
